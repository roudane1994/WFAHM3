...
import static ma.beit.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import java.util.*;
import ma.beit.Wfahm3App;
import ma.beit.config.Constants;
import ma.beit.domain.User;
import ma.beit.repository.AuthorityRepository;
import ma.beit.repository.UserRepository;
import ma.beit.security.AuthoritiesConstants;
import ma.beit.service.UserService;
import ma.beit.service.dto.PasswordChangeDTO;
import ma.beit.service.dto.UserDTO;
import ma.beit.web.rest.vm.KeyAndPasswordVM;
import ma.beit.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = Wfahm3App.class)
